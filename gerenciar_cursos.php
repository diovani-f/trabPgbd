...
<body>
    <div class="container">
        ...
        <a href="cadastrar_curso.php" class="button create">Criar Curso</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
                ...
                <?php if ($resultado && $resultado->num_rows > 0): ?>
                    <?php while ($row = $resultado->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <button class="button edit" onclick="window.location.href='editar_curso.php?id=<?php echo $row['id']; ?>'">Editar</button>
                                <button class="button delete" onclick="window.location.href='excluir_curso.php?id=<?php echo $row['id']; ?>'">Excluir</button>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
